...
thi.ng.geom.gmesh.add_face_STAR_ = (function thi$ng$geom$gmesh$add_face_STAR_(p__15063,p__15064){
var map__15066 = p__15063;
var map__15066__$1 = cljs.core.__destructure_map(map__15066);
var mesh = map__15066__$1;
var vertices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15066__$1,new cljs.core.Keyword(null,"vertices","vertices",2008905731));
var edges = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15066__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
var faces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15066__$1,new cljs.core.Keyword(null,"faces","faces",-73909544));
var vec__15068 = p__15064;
var verts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15068,(0),null);
var f = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__15056_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.find(vertices,p1__15056_SHARP_),(0),p1__15056_SHARP_);
}),verts);
...
var vertices__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__15082){
var vec__15084 = p__15082;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15084,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15084,(1),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15084,(2),null);
...
thi.ng.geom.gmesh.vertices_planar_QMARK_ = (function thi$ng$geom$gmesh$vertices_planar_QMARK_(p__15091){
var vec__15092 = p__15091;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15092,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15092,(1),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15092,(2),null);
var verts = vec__15092;
var or__5043__auto__ = (cljs.core.count(verts) < (4));
if(or__5043__auto__){
return or__5043__auto__;
} else {
var n = thi.ng.geom.utils.ortho_normal.cljs$core$IFn$_invoke$arity$3(a,b,c);
return cljs.core.every_QMARK_((function (p1__15090_SHARP_){
return thi.ng.math.core.delta_EQ_(n,thi.ng.geom.utils.ortho_normal.cljs$core$IFn$_invoke$arity$1(p1__15090_SHARP_));
...
thi.ng.geom.gmesh.face_neighbors_shared_edges = (function thi$ng$geom$gmesh$face_neighbors_shared_edges(p__15106,f){
var map__15107 = p__15106;
var map__15107__$1 = cljs.core.__destructure_map(map__15107);
var edges = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15107__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,pair){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(acc,cljs.core.disj.cljs$core$IFn$_invoke$arity$2((function (){var G__15110 = cljs.core.set(pair);
return (edges.cljs$core$IFn$_invoke$arity$1 ? edges.cljs$core$IFn$_invoke$arity$1(G__15110) : edges.call(null,G__15110));
})(),f));
...
thi.ng.geom.gmesh.vertex_neighbors_STAR_ = (function thi$ng$geom$gmesh$vertex_neighbors_STAR_(p__15115,v){
var map__15117 = p__15115;
var map__15117__$1 = cljs.core.__destructure_map(map__15117);
var vertices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15117__$1,new cljs.core.Keyword(null,"vertices","vertices",2008905731));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__15125_SHARP_,p2__15126_SHARP_){
return thi.ng.geom.gmesh.add_face_STAR_(p1__15125_SHARP_,cljs.core.replace.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.createAsIfByAssoc([v,v2]),p2__15126_SHARP_));
}),mesh,faces);
}));
...
if(cljs.core.truth_((function (){var fexpr__15133 = thi.ng.geom.gmesh.vertex_neighbors_STAR_(mesh,a);
return (fexpr__15133.cljs$core$IFn$_invoke$arity$1 ? fexpr__15133.cljs$core$IFn$_invoke$arity$1(b) : fexpr__15133.call(null,b));
})())){
...
var mp = thi.ng.math.core.mix(a,b);
...
var theta = (i * phi);
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__15134_SHARP_){
var p = (rot_fn.cljs$core$IFn$_invoke$arity$2 ? rot_fn.cljs$core$IFn$_invoke$arity$2(p1__15134_SHARP_,theta) : rot_fn.call(null,p1__15134_SHARP_,theta));
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(p,p1__15134_SHARP_,thi.ng.math.core._STAR_eps_STAR_))){
return p1__15134_SHARP_;
} else {
return p;
}
}),points);
}),cljs.core.butlast(thi.ng.math.core.norm_range(res)));
var strips__$1 = (cljs.core.truth_(thi.ng.math.core.delta_EQ_(phi,thi.ng.math.core.TWO_PI))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(strips,cljs.core.first(strips)):strips);
var make_face = (function (p__15156,p__15157){
var vec__15158 = p__15156;
var a1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15158,(0),null);
var a2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15158,(1),null);
var vec__15161 = p__15157;
var b1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15161,(0),null);
var b2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15161,(1),null);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__5041__auto__ = f;
...
return thi.ng.geom.utils.into_mesh(thi.ng.geom.gmesh.gmesh(),thi.ng.geom.gmesh.add_face_STAR_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__15168){
var vec__15169 = p__15168;
var sa = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15169,(0),null);
var sb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15169,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__15173){
var vec__15174 = p__15173;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15174,(0),null);
var flags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15174,(1),null);
return thi.ng.geom.utils.into_mesh(m,thi.ng.geom.gmesh.add_face_STAR_,thi.ng.geom.core.as_mesh((new thi.ng.geom.types.AABB(p,s,null,null,null)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"flags","flags",1775418075),flags], null)));
...
var ___$1 = this;
return thi.ng.geom.utils.transform_mesh(___$1,thi.ng.geom.gmesh.add_face_STAR_,(function (p1__15184_SHARP_){
return thi.ng.math.core._STAR_(p1__15184_SHARP_,s);
}));
}));
...
return thi.ng.geom.utils.transform_mesh(___$1,thi.ng.geom.gmesh.add_face_STAR_,(function (p1__15185_SHARP_){
return thi.ng.math.core.madd(thi.ng.math.core._(p1__15185_SHARP_,c),s,c);
}));
}));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15181_SHARP_){
return thi.ng.geom.core.raw(p1__15181_SHARP_,___$1);
...
(thi.ng.geom.types.GMesh.prototype.thi$ng$geom$core$IFaceAccess$remove_face$arity$2 = (function (p__15206,f){
var map__15207 = p__15206;
var map__15207__$1 = cljs.core.__destructure_map(map__15207);
var _ = map__15207__$1;
var vertices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15207__$1,new cljs.core.Keyword(null,"vertices","vertices",2008905731));
var edges = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15207__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
var faces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15207__$1,new cljs.core.Keyword(null,"faces","faces",-73909544));
var fnormals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15207__$1,new cljs.core.Keyword(null,"fnormals","fnormals",-1783998563));
var vnormals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15207__$1,new cljs.core.Keyword(null,"vnormals","vnormals",-914875284));
var map__15212 = this;
var map__15212__$1 = cljs.core.__destructure_map(map__15212);
var ___$1 = map__15212__$1;
var vertices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15212__$1,new cljs.core.Keyword(null,"vertices","vertices",2008905731));
var edges__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15212__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
var faces__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15212__$1,new cljs.core.Keyword(null,"faces","faces",-73909544));
var fnormals__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15212__$1,new cljs.core.Keyword(null,"fnormals","fnormals",-1783998563));
var vnormals__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15212__$1,new cljs.core.Keyword(null,"vnormals","vnormals",-914875284));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(faces__$1,f))){
var fv = thi.ng.geom.core.vertices(f,___$1);
...
var vec__15216 = cljs.core.first(fedges);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15216,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15216,(1),null);
...
var ve = cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (verts,vnorms,edges__$2,fedges,vec__15216,a,b,e,efaces,edges__$3,fv,map__15212,map__15212__$1,___$1,vertices__$1,edges__$1,faces__$1,fnormals__$1,vnormals__$1,map__15207,map__15207__$1,_,vertices,edges,faces,fnormals,vnormals){
return (function (p1__15182_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__15182_SHARP_,new cljs.core.Keyword(null,"f","f",-1597136552)),f);
});})(verts,vnorms,edges__$2,fedges,vec__15216,a,b,e,efaces,edges__$3,fv,map__15212,map__15212__$1,___$1,vertices__$1,edges__$1,faces__$1,fnormals__$1,vnormals__$1,map__15207,map__15207__$1,_,vertices,edges,faces,fnormals,vnormals))
,cljs.core.get.cljs$core$IFn$_invoke$arity$2(verts,a));
if(cljs.core.seq(ve)){
var G__15335 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(verts,a,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,ve));
var G__15336 = vnorms;
var G__15337 = edges__$3;
var G__15338 = cljs.core.next(fedges);
verts = G__15335;
vnorms = G__15336;
edges__$2 = G__15337;
fedges = G__15338;
...
var G__15339 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(verts,a);
var G__15340 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(vnorms,a);
var G__15341 = edges__$3;
var G__15342 = cljs.core.next(fedges);
verts = G__15339;
vnorms = G__15340;
edges__$2 = G__15341;
fedges = G__15342;
...
var ___$1 = this;
return thi.ng.geom.utils.transform_mesh(___$1,thi.ng.geom.gmesh.add_face_STAR_,(function (p1__15186_SHARP_){
return thi.ng.math.core._PLUS_(p1__15186_SHARP_,t);
}));
}));
...
var vec__15246 = thi.ng.dstruct.core.index_BANG_(norms,thi.ng.geom.utils.ortho_normal.cljs$core$IFn$_invoke$arity$1(f.vertices));
var norms__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15246,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15246,(1),null);
var G__15356 = norms__$1;
var G__15357 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(fnorms,f,n);
var G__15358 = cljs.core.next(faces);
norms = G__15356;
fnorms = G__15357;
faces = G__15358;
continue;
...
var vertices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15253__$1,new cljs.core.Keyword(null,"vertices","vertices",2008905731));
var normals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15253__$1,new cljs.core.Keyword(null,"normals","normals",-1508109067));
var fnormals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15253__$1,new cljs.core.Keyword(null,"fnormals","fnormals",-1783998563));
var ntx = cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__15183_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(fnormals,p1__15183_SHARP_);
}));
...
var vec__15272 = thi.ng.dstruct.core.index_BANG_(norms,thi.ng.math.core.normalize(cljs.core.transduce.cljs$core$IFn$_invoke$arity$4(ntx,thi.ng.math.core._PLUS_,thi.ng.geom.vector.V3,thi.ng.dstruct.core.value_set.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"f","f",-1597136552),vertices,v))));
var norms__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15272,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15272,(1),null);
var G__15360 = norms__$1;
var G__15361 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(vnorms,v,n);
var G__15362 = cljs.core.next(verts);
norms = G__15360;
vnorms = G__15361;
verts = G__15362;
continue;
...
var ___$1 = this;
return thi.ng.geom.core.center(___$1,thi.ng.geom.vector.vec3.cljs$core$IFn$_invoke$arity$0());
}));

(thi.ng.geom.types.GMesh.prototype.thi$ng$geom$core$ICenter$center$arity$2 = (function (_,o){
var ___$1 = this;
return thi.ng.geom.core.translate(___$1,thi.ng.math.core._(o,thi.ng.geom.core.centroid(___$1)));
}));
...
var ___$1 = this;
return thi.ng.geom.utils.map_mesh((function (){var or__5043__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"fn","fn",-1175266204));
