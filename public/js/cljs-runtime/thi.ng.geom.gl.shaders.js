...
var vec__17381 = ((cljs.core.sequential_QMARK_(type))?type:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [type], null));
var type__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17381,(0),null);
var default$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17381,(1),null);
var opt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17381,(2),null);
var vec__17384 = (thi.ng.geom.gl.shaders.uniform_types.cljs$core$IFn$_invoke$arity$1 ? thi.ng.geom.gl.shaders.uniform_types.cljs$core$IFn$_invoke$arity$1(type__$1) : thi.ng.geom.gl.shaders.uniform_types.call(null,type__$1));
var setter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17384,(0),null);
var u_cast = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17384,(1),null);
var u_len = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17384,(2),null);
var setter__$1 = (gl[["uniform",cljs.core.str.cljs$core$IFn$_invoke$arity$1(setter)].join('')]);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(umap,id,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),type__$1,new cljs.core.Keyword(null,"default","default",-1987822328),default$,new cljs.core.Keyword(null,"setter","setter",1948354926),(cljs.core.truth_((function (){var fexpr__17387 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"int","int",-1741416922),null,new cljs.core.Keyword(null,"float","float",-1732389368),null,new cljs.core.Keyword(null,"bool","bool",1444635321),null,new cljs.core.Keyword(null,"sampler2D","sampler2D",-2107312644),null], null), null);
return (fexpr__17387.cljs$core$IFn$_invoke$arity$1 ? fexpr__17387.cljs$core$IFn$_invoke$arity$1(type__$1) : fexpr__17387.call(null,type__$1));
})())?(function (x){
...
}):(cljs.core.truth_((function (){var fexpr__17388 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"mat3","mat3",402087048),null,new cljs.core.Keyword(null,"mat2","mat2",238424363),null,new cljs.core.Keyword(null,"mat4","mat4",-237531594),null], null), null);
return (fexpr__17388.cljs$core$IFn$_invoke$arity$1 ? fexpr__17388.cljs$core$IFn$_invoke$arity$1(type__$1) : fexpr__17388.call(null,type__$1));
})())?(function (x){
...
var x__$1 = (cljs.core.truth_(thi.ng.typedarrays.core.typed_array_QMARK_(x))?x:(((((!((x == null))))?((((false) || ((cljs.core.PROTOCOL_SENTINEL === x.thi$ng$dstruct$streams$IBuffer$))))?true:(((!x.cljs$lang$protocol_mask$partition$))?cljs.core.native_satisfies_QMARK_(thi.ng.dstruct.streams.IBuffer,x):false)):cljs.core.native_satisfies_QMARK_(thi.ng.dstruct.streams.IBuffer,x)))?thi.ng.dstruct.streams.get_float_buffer(x):((typeof x === 'number')?(function (){var G__17390 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,x], null);
return (u_cast.cljs$core$IFn$_invoke$arity$1 ? u_cast.cljs$core$IFn$_invoke$arity$1(G__17390) : u_cast.call(null,G__17390));
...
var x__$1 = (cljs.core.truth_(thi.ng.typedarrays.core.typed_array_QMARK_(x))?x:(((((!((x == null))))?((((false) || ((cljs.core.PROTOCOL_SENTINEL === x.thi$ng$dstruct$streams$IBuffer$))))?true:(((!x.cljs$lang$protocol_mask$partition$))?cljs.core.native_satisfies_QMARK_(thi.ng.dstruct.streams.IBuffer,x):false)):cljs.core.native_satisfies_QMARK_(thi.ng.dstruct.streams.IBuffer,x)))?thi.ng.dstruct.streams.get_float_buffer(x):((typeof x === 'number')?(function (){var G__17392 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(cljs.core.deref(thi.ng.color.core.int24(x).thi$ng$color$core$IRGBConvert$as_rgba$arity$1(null)),(0),(3));
return (u_cast.cljs$core$IFn$_invoke$arity$1 ? u_cast.cljs$core$IFn$_invoke$arity$1(G__17392) : u_cast.call(null,G__17392));
})():(u_cast.cljs$core$IFn$_invoke$arity$1 ? u_cast.cljs$core$IFn$_invoke$arity$1(x) : u_cast.call(null,x))
)));
return setter__$1.call(gl,loc,x__$1);
...
return setter__$1.call(gl,loc,(cljs.core.truth_(thi.ng.typedarrays.core.typed_array_QMARK_(x))?x:(function (){var G__17395 = (((!(cljs.core.sequential_QMARK_(x))))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [x], null):x);
return (u_cast.cljs$core$IFn$_invoke$arity$1 ? u_cast.cljs$core$IFn$_invoke$arity$1(G__17395) : u_cast.call(null,G__17395));
})()));
})
...
var temp__5802__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(shader,new cljs.core.Keyword(null,"uniforms","uniforms",-782808153)),id);
if(cljs.core.truth_(temp__5802__auto__)){
var u_spec = temp__5802__auto__;
var G__17397 = ((cljs.core.fn_QMARK_(val))?(val.cljs$core$IFn$_invoke$arity$2 ? val.cljs$core$IFn$_invoke$arity$2(shader,uniforms) : val.call(null,shader,uniforms)):val);
var fexpr__17396 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(u_spec,new cljs.core.Keyword(null,"setter","setter",1948354926));
...
var temp__5802__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(val,new cljs.core.Keyword(null,"default","default",-1987822328));
if(cljs.core.truth_(temp__5802__auto__)){
...
var map__17401 = attrib_spec;
var map__17401__$1 = cljs.core.__destructure_map(map__17401);
var buffer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17401__$1,new cljs.core.Keyword(null,"buffer","buffer",617295198));
var stride = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17401__$1,new cljs.core.Keyword(null,"stride","stride",-1172818435));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17401__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17401__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var normalized_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17401__$1,new cljs.core.Keyword(null,"normalized?","normalized?",1246099953));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17401__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var loc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17401__$1,new cljs.core.Keyword(null,"loc","loc",-584284901));
var temp__5802__auto__ = (cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(shader,new cljs.core.Keyword(null,"attribs","attribs",-137878093)),id) | (0));
if(cljs.core.truth_(temp__5802__auto__)){
var loc__$1 = temp__5802__auto__;
var G__17403 = gl;
G__17403.bindBuffer(thi.ng.geom.gl.webgl.constants.array_buffer,buffer);

G__17403.enableVertexAttribArray(loc__$1);

G__17403.vertexAttribPointer(loc__$1,(size | (0)),(function (){var or__5043__auto__ = type;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return thi.ng.geom.gl.webgl.constants.float$;
}
})(),cljs.core.boolean$(normalized_QMARK_),(function (){var or__5043__auto__ = stride;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (0);
}
})(),(function (){var or__5043__auto__ = offset;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (0);
...
var temp__5802__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(shader,new cljs.core.Keyword(null,"attribs","attribs",-137878093)),id);
if(cljs.core.truth_(temp__5802__auto__)){
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__17404){
var vec__17405 = p__17404;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17405,(0),null);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17405,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__17408){
var vec__17409 = p__17408;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17409,(0),null);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17409,(1),null);
...
thi.ng.geom.gl.shaders.prepare_shader_sources = (function thi$ng$geom$gl$shaders$prepare_shader_sources(p__17412){
var map__17413 = p__17412;
var map__17413__$1 = cljs.core.__destructure_map(map__17413);
var vs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17413__$1,new cljs.core.Keyword(null,"vs","vs",-2022097090));
var fs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17413__$1,new cljs.core.Keyword(null,"fs","fs",-2122926244));
var uniforms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17413__$1,new cljs.core.Keyword(null,"uniforms","uniforms",-782808153));
var attribs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17413__$1,new cljs.core.Keyword(null,"attribs","attribs",-137878093));
var varying = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17413__$1,new cljs.core.Keyword(null,"varying","varying",685535123));
var prelude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17413__$1,new cljs.core.Keyword(null,"prelude","prelude",-138977836));
var version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17413__$1,new cljs.core.Keyword(null,"version","version",425292698));
var gl3_QMARK_ = (function (){var and__5041__auto__ = version;
...
var src__$1 = [src,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5043__auto__ = prelude;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var vec__17416 = cljs.core.re_find(/ERROR: \d+:(\d+): (.*)/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17416,(0),null);
var ln = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17416,(1),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17416,(2),null);
...
var temp__5802__auto__ = gl.createShader(type);
if(cljs.core.truth_(temp__5802__auto__)){
var shader = temp__5802__auto__;
...
var uniforms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17421__$1,new cljs.core.Keyword(null,"uniforms","uniforms",-782808153));
var attribs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17421__$1,new cljs.core.Keyword(null,"attribs","attribs",-137878093));
var map__17422 = thi.ng.geom.gl.shaders.prepare_shader_sources(spec);
var map__17422__$1 = cljs.core.__destructure_map(map__17422);
var vs_src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17422__$1,new cljs.core.Keyword(null,"vs-src","vs-src",-692281053));
var fs_src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17422__$1,new cljs.core.Keyword(null,"fs-src","fs-src",1463465927));
...
var G__17423_17431 = gl;
G__17423_17431.attachShader(prog,vs);

G__17423_17431.attachShader(prog,fs);

thi.ng.geom.gl.shaders.bind_attrib_locations(G__17423_17431,prog,attribs);

G__17423_17431.linkProgram(prog);
...
var G__17424_17432 = gl;
G__17424_17432.deleteShader(vs);

G__17424_17432.deleteShader(fs);
...
thi.ng.geom.gl.shaders.make_shader_from_dom = (function thi$ng$geom$gl$shaders$make_shader_from_dom(gl,p__17425){
var map__17426 = p__17425;
var map__17426__$1 = cljs.core.__destructure_map(map__17426);
var spec = map__17426__$1;
var vs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17426__$1,new cljs.core.Keyword(null,"vs","vs",-2022097090));
var fs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17426__$1,new cljs.core.Keyword(null,"fs","fs",-2122926244));
