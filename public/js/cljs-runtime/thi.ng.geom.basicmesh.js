...
thi.ng.geom.basicmesh.add_face_STAR_ = (function thi$ng$geom$basicmesh$add_face_STAR_(mesh,p__15057){
var vec__15058 = p__15057;
var fverts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15058,(0),null);
...
var ___$1 = this;
return thi.ng.geom.utils.transform_mesh(___$1,thi.ng.geom.basicmesh.add_face_STAR_,(function (p1__15077_SHARP_){
return thi.ng.math.core._STAR_(p1__15077_SHARP_,s);
}));
}));
...
return thi.ng.geom.utils.transform_mesh(___$1,thi.ng.geom.basicmesh.add_face_STAR_,(function (p1__15078_SHARP_){
return thi.ng.math.core.madd(thi.ng.math.core._(p1__15078_SHARP_,c),s,c);
}));
}));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15071_SHARP_){
return thi.ng.geom.core.raw(p1__15071_SHARP_,___$1);
...
var ___$1 = this;
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__15074_SHARP_){
return thi.ng.geom.core.vertices(p1__15074_SHARP_,___$1);
})),cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__15075_SHARP_){
return (thi.ng.dstruct.core.index_of(p1__15075_SHARP_,v) > (0));
})),cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"faces","faces",-73909544))));
}));
...
var ___$1 = this;
return thi.ng.geom.utils.transform_mesh(___$1,thi.ng.geom.basicmesh.add_face_STAR_,(function (p1__15079_SHARP_){
return thi.ng.math.core._PLUS_(p1__15079_SHARP_,t);
}));
}));
...
var G__15146 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(fnorms,f,thi.ng.geom.utils.ortho_normal.cljs$core$IFn$_invoke$arity$1(thi.ng.geom.core.vertices(f,___$1)));
var G__15147 = cljs.core.next(faces);
fnorms = G__15146;
faces = G__15147;
continue;
} else {
...
var ___$1 = this;
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentHashSet.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__15065_SHARP_){
return thi.ng.geom.core.vertices(p1__15065_SHARP_,___$1);
})),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$1((function (p1__15067_SHARP_){
return thi.ng.dstruct.core.successive_nth.cljs$core$IFn$_invoke$arity$2((2),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__15067_SHARP_,cljs.core.first(p1__15067_SHARP_)));
