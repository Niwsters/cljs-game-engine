...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,k,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__15061_SHARP_,p2__15062_SHARP_){
return (f.cljs$core$IFn$_invoke$arity$4 ? f.cljs$core$IFn$_invoke$arity$4(face_id,p1__15061_SHARP_,p2__15062_SHARP_,opts) : f.call(null,face_id,p1__15061_SHARP_,p2__15062_SHARP_,opts));
}),verts));
...
return (function (_,id,___$1,opts){
var G__15083 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(opts,attrib),id);
return (tx.cljs$core$IFn$_invoke$arity$1 ? tx.cljs$core$IFn$_invoke$arity$1(G__15083) : tx.call(null,G__15083));
});
}));
...
var iu = (uw - u);
var iv = (vh - v);
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__15087_SHARP_){
return thi.ng.math.core._PLUS_(p1__15087_SHARP_,x,y);
...
var fw = ((w / tw) / 6.0);
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__15099_SHARP_){
return thi.ng.geom.attribs.uv_rect_for_size.cljs$core$IFn$_invoke$arity$6(h,h,(p1__15099_SHARP_ * fw),0.0,fw,1.0);
...
var fh = ((h / th) / 6.0);
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__15111_SHARP_){
return thi.ng.geom.attribs.uv_rect_for_size.cljs$core$IFn$_invoke$arity$6(w,w,0.0,(p1__15111_SHARP_ * fh),1.0,fh);
}),cljs.core.range.cljs$core$IFn$_invoke$arity$1((6)));
}));
 ...
 */
thi.ng.geom.attribs.uv_tube = (function thi$ng$geom$attribs$uv_tube(_,vid,___$1,p__15116){
var map__15118 = p__15116;
var map__15118__$1 = cljs.core.__destructure_map(map__15118);
var u = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15118__$1,new cljs.core.Keyword(null,"u","u",-1156634785));
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15118__$1,new cljs.core.Keyword(null,"v","v",21465059));
var du = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15118__$1,new cljs.core.Keyword(null,"du","du",1000321745));
var dv = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15118__$1,new cljs.core.Keyword(null,"dv","dv",781315158));
var G__15119 = (vid | (0));
switch (G__15119) {
case (0):
 ...
 */
thi.ng.geom.attribs.uv_flat_disc = (function thi$ng$geom$attribs$uv_flat_disc(_,vid,___$1,p__15120){
var map__15121 = p__15120;
var map__15121__$1 = cljs.core.__destructure_map(map__15121);
var opts = map__15121__$1;
var theta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15121__$1,new cljs.core.Keyword(null,"theta","theta",-427510258));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15121__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var G__15122 = (vid | (0));
switch (G__15122) {
case (0):
...
return thi.ng.geom.attribs.face_attribs(cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__15124_SHARP_){
return thi.ng.math.core._PLUS_(thi.ng.geom.vector.vec2.cljs$core$IFn$_invoke$arity$2(0.5,(p1__15124_SHARP_ * thi.ng.math.core.TWO_PI)).thi$ng$geom$core$IPolar$as_cartesian$arity$1(null),0.5);
