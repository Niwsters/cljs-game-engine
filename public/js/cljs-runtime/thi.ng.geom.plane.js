...
return (new thi.ng.geom.types.Plane(thi.ng.math.core.normalize(thi.ng.geom.vector.vec3.cljs$core$IFn$_invoke$arity$1(n)),w,null,null,null));
});
thi.ng.geom.plane.plane_with_point = (function thi$ng$geom$plane$plane_with_point(p,n){
var n__$1 = thi.ng.math.core.normalize(thi.ng.geom.vector.vec3.cljs$core$IFn$_invoke$arity$1(n));
return (new thi.ng.geom.types.Plane(n__$1,(- thi.ng.math.core.dot(n__$1,p)),null,null,null));
});
...
(thi.ng.geom.plane.plane_from_points.cljs$core$IFn$_invoke$arity$1 = (function (p__15343){
...
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15344,(2),null);
...
return (new thi.ng.geom.types.Plane(n,(- thi.ng.math.core.dot(n,a)),null,null,null));
}));
...
(thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$IProximity$closest_point$arity$2 = (function (p__15363,p){
var map__15364 = p__15363;
var map__15364__$1 = cljs.core.__destructure_map(map__15364);
var _ = map__15364__$1;
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15364__$1,new cljs.core.Keyword(null,"n","n",562130025));
var map__15365 = this;
var map__15365__$1 = cljs.core.__destructure_map(map__15365);
var ___$1 = map__15365__$1;
var n__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15365__$1,new cljs.core.Keyword(null,"n","n",562130025));
return thi.ng.math.core._(p,thi.ng.math.core.normalize(n__$1,(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"w","w",354169001)) + thi.ng.math.core.dot(n__$1,p))));
}));
...
var ___$1 = this;
return (thi.ng.math.core.dot(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025)),p) + cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"w","w",354169001)));
}));
...
(thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$IExtrude$extrude$arity$2 = (function (_,p__15375){
...
var ___$1 = this;
return thi.ng.geom.plane.plane_with_point(thi.ng.math.core._STAR_(thi.ng.geom.core.centroid(___$1),s),cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025)));
}));
...
var ___$1 = this;
return (new thi.ng.geom.types.Plane(thi.ng.math.core._(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025))),(- cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"w","w",354169001))),null,null,null));
}));
...
(thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$IMeshConvert$as_mesh$arity$2 = (function (_,p__15387){
var map__15388 = p__15387;
var map__15388__$1 = cljs.core.__destructure_map(map__15388);
var p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15388__$1,new cljs.core.Keyword(null,"p","p",151049309));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15388__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15388__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15388__$1,new cljs.core.Keyword(null,"size","size",1098693007),1.0);
var mesh = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15388__$1,new cljs.core.Keyword(null,"mesh","mesh",456320595));
var attribs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15388__$1,new cljs.core.Keyword(null,"attribs","attribs",-137878093));
var ___$1 = this;
var w = ((function (){var or__5043__auto__ = width;
...
var h = ((function (){var or__5043__auto__ = height;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return size;
...
var flip_QMARK_ = thi.ng.math.core.delta_EQ_(-1.0,thi.ng.math.core.dot(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025)),thi.ng.geom.vector.V3Z));
var p__$1 = thi.ng.geom.core.closest_point(___$1,(function (){var or__5043__auto__ = p;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var face = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__15359_SHARP_){
return thi.ng.math.core._PLUS_(p__$1,q.thi$ng$geom$core$IVectorTransform$transform_vector$arity$2(null,p1__15359_SHARP_));
...
var ___$1 = this;
var vec__15395 = ((cljs.core.map_QMARK_(l))?cljs.core.get.cljs$core$IFn$_invoke$arity$2(l,new cljs.core.Keyword(null,"points","points",-1486596883)):l);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15395,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15395,(1),null);
return thi.ng.geom.utils.intersect.intersect_ray_plane_QMARK_(p,thi.ng.math.core._(q,p),cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025)),cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"w","w",354169001)));
}));
...
var ___$1 = this;
var vec__15402 = ((cljs.core.map_QMARK_(ray))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get.cljs$core$IFn$_invoke$arity$2(ray,new cljs.core.Keyword(null,"p","p",151049309)),cljs.core.get.cljs$core$IFn$_invoke$arity$2(ray,new cljs.core.Keyword(null,"dir","dir",1734754661))], null):ray);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15402,(0),null);
var dir = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15402,(1),null);
...
var ___$1 = this;
return thi.ng.geom.plane.plane_with_point(thi.ng.math.core._PLUS_(thi.ng.geom.core.centroid(___$1),t),cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025)));
}));
...
var ___$1 = this;
return thi.ng.math.core.signum.cljs$core$IFn$_invoke$arity$2((thi.ng.math.core.dot(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025)),p) + cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"w","w",354169001))),thi.ng.math.core._STAR_eps_STAR_);
}));
...
var ___$1 = this;
return thi.ng.math.core._STAR_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025)),(- cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"w","w",354169001))));
}));
...
var ___$1 = this;
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(thi.ng.math.core.abs(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025))),thi.ng.geom.vector.V3X,thi.ng.math.core._STAR_eps_STAR_))){
return 0.0;
} else {
return thi.ng.math.core.INF_PLUS_;
}
...
var ___$1 = this;
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(thi.ng.math.core.abs(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025))),thi.ng.geom.vector.V3Y,thi.ng.math.core._STAR_eps_STAR_))){
return 0.0;
} else {
return thi.ng.math.core.INF_PLUS_;
}
...
var ___$1 = this;
if(cljs.core.truth_(thi.ng.math.core.delta_EQ_(thi.ng.math.core.abs(cljs.core.get.cljs$core$IFn$_invoke$arity$2(___$1,new cljs.core.Keyword(null,"n","n",562130025))),thi.ng.geom.vector.V3Z,thi.ng.math.core._STAR_eps_STAR_))){
return 0.0;
} else {
return thi.ng.math.core.INF_PLUS_;
}
